import { createElement, Fragment as Fragment$1, useEffect as useEffect$1 } from 'react';
 ...
 * @param delay
 */
var debounce = function (id, delay) {
    var timers = {};
...
var scrollSpy = function () {
    ...
    return {
        init: function (initData) {
            var element = initData.element, _a = initData.immediate, immediate = _a === void 0 ? false : _a, onScroll = initData.onScroll;
...
InfiScroller.propTypes = {
    ...
    scrollTarget: propTypes_14([
        propTypes_8,
        propTypes_1
    ]),
    debounceDelay: propTypes_5,
    gutter: propTypes_5,
    immediate: propTypes_3,
    active: propTypes_3,
    hasMore: propTypes_3,
    shouldLoadMore: propTypes_4,
    onLoadMore: propTypes_4.isRequired
};
InfiScroller.defaultProps = {
    ...
    active: true,
    hasMore: false,
    shouldLoadMore: function (targetHeight, scrollYOffset, gutter, scrollHeight) { return (targetHeight + scrollYOffset + gutter >= scrollHeight); }
};
